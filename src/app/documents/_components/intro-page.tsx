...
const IntroPage = () => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row md:justify-between items-center justify-center h-full bg-gradient-to-t from-blue-100 to-white dark:from-gray-900 dark:to-gray-800">
